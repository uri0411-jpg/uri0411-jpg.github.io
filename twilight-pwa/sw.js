...
const CACHE_NAME  = 'twl-v24';  // bumped: forecast accuracy % replaces calibration/volume metrics
...
const STATIC_ASSETS = [
  ...
  './js/engine/spectralEngine.js',
  './js/render/skyGradient.js',
  './learning-seed.json'     // auto-seed historical calibration data
];
